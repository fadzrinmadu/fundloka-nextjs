      ...
      <section className="container mx-auto pt-8">
        <div className="flex justify-between items-center">
          <div className="w-full md:w-3/4 mr-6">
            <h2 className="text-4xl text-gray-900 mb-2 font-medium">{campaign.data.name}</h2>
            <p className="font-light text-xl mb-5">{campaign.data.short_description}</p>
            ...
            <p className="font-light text-xl mb-5">{campaign.data.description}</p>
          </div>
